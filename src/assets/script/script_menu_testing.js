// Minimal JavaScript for rendering and simple interactions.
// Renders products grouped by subcategory headings (e.g., <h2>Coffee</h2>)
// Keeps product article markup and visual styles unchanged.
...
// script_menu_testing.js
// Adds vertical sidebar category nav, sticky behavior, sub-filters, and grouped sub-headings
// Keeps header and footer unchanged; product-card markup unchanged.
  ...
  function renderProducts(list) {
    ...
    // default flat render for 'All'
    grid.innerHTML = list.map(articleMarkup).join('');
  }
  ...
  // Event handling: click, chips, sub-chips, quick view
